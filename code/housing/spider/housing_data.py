...
class HousingSpider (scrapy.Spider):
    name = 'squarefoot'
    page_number = 2
    start_urls = ['https://www.squarefoot.com.hk/buy?page=1&searchText=&myfav=&myvisited=&item_ids=&sortBy'
                  '=&search_words_thing=default&buyRent=buy&mobilePageChannel=&cat_ids=&search_words_value'
                  '=&is_return_newmenu=0&plan_id=&propertyDoSearchVersion=2.0&sortBy=default&locations=0'
                  '&locations_by_text=0&price=0&price_by_text=0&mainType=0&mainType_by_text=0&others=0&others_by_text'
                  '=0&roomRange=&roomRange_by_text=0&areaOption=&areaOption_by_text=0&areaRange=&areaRange_by_text=0'
                  '&yearRange=&yearRange_by_text=0&floors=&floors_by_text=0&searchTags=&searchTags_by_text=0']

    def parse(self, response):
        items = HousingItem()
        list_house = response.css('.property_item')
